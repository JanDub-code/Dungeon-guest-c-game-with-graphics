...
void Scene5::initScene(Player *player, Camera *cam, std::vector<Tile*> *&tiles, tileGenerator &tg)
{
    tg.setMap(5);
    ...
    Door *door(new Door(1, Vec2f(14.01F,3.01F)));
    door->setPos(Vec2f(5.0F,1.0F));
    door->setTexture("Portals/portal_purple.png");
...
void Scene5::loadAmbientMusic(QMediaPlayer &amb_mus)
{
